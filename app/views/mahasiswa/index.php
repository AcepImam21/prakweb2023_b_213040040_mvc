        ...
        <div class="col-lg-6">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs['id']; ?>" class="badge badge-success float-right ml-1 tampilModalUbah" data-toggle="modal" data-target="#exampleModal" data-id="<?= $mhs['id']; ?>">ubah</a>
